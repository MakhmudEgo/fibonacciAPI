...
func (c *fibonacciClient) Get(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/fibonacci_proto.Fibonacci/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFibonacciServer) Get(context.Context, *Request) (*Response, error) {
...
func _Fibonacci_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fibonacci_proto.Fibonacci/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FibonacciServer).Get(ctx, req.(*Request))
	}
...
var Fibonacci_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fibonacci_proto.Fibonacci",
